About simplesat-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/simplesat-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6646&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/simplesat-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `simplesat` can be installed with `conda`:
...
```
mamba install simplesat
```

It is possible to list all of the versions of `simplesat` available on your platform with `conda`:
...
```
mamba search simplesat --channel conda-forge
```
...
mamba repoquery search simplesat --channel conda-forge

# List packages depending on `simplesat`:
mamba repoquery whoneeds simplesat --channel conda-forge

# List dependencies of `simplesat`:
mamba repoquery depends simplesat --channel conda-forge
```
